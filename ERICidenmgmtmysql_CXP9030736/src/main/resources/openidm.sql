...
DROP DATABASE IF EXISTS openidm; 
...
-- ------------------------------------------
GRANT ALL PRIVILEGES on openidm.* TO openidm IDENTIFIED BY 'MYSQL_OPENIDM_PASSWORD';
GRANT ALL PRIVILEGES on openidm.* TO openidm@'%' IDENTIFIED BY  'MYSQL_OPENIDM_PASSWORD';
GRANT ALL PRIVILEGES on openidm.* TO openidm@localhost IDENTIFIED BY 'MYSQL_OPENIDM_PASSWORD';
